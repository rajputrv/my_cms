<!-- Sidebar Menu Items - These collapse to the responsive navigation menu on small screens -->
               <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#posts_dropdown"> <i class="fa fa-fw fa-check "></i> Posts <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="posts_dropdown" class="collapse">
                            <li>
                                <a href="posts.php"><i class="fa fa-fw fa-eye "></i> View All Posts</a>
                            </li>
                            <li>
                                <a href="posts.php?source=add_post"><i class="fa fa-fw fa-pencil "></i> Add a post</a>
                            </li>
                        </ul>
                    </li>
                     <li class="">
